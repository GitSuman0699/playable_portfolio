...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1313: x0 => ({type: x0}),
      _1314: (x0,x1) => new Blob(x0,x1),
      _1315: (x0,x1) => x0.item(x1),
      _1316: () => new FileReader(),
      ...
      _1320: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1367: Object.is,
      _1368: o => o instanceof Array,
      _1369: (a, i) => a.push(i),
      _1373: a => a.pop(),
      _1374: (a, i) => a.splice(i, 1),
      _1375: (a, s) => a.join(s),
      _1376: (a, s, e) => a.slice(s, e),
      _1379: a => a.length,
      _1381: (a, i) => a[i],
      _1382: (a, i, v) => a[i] = v,
      _1384: o => {
      ...
      _1385: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1387: o => o instanceof Uint8Array,
      _1388: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1389: o => o instanceof Int8Array,
      _1390: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1391: o => o instanceof Uint8ClampedArray,
      _1392: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1393: o => o instanceof Uint16Array,
      _1394: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1395: o => o instanceof Int16Array,
      _1396: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1397: o => o instanceof Uint32Array,
      _1398: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1399: o => o instanceof Int32Array,
      ...
      _1403: o => o instanceof Float32Array,
      _1404: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1405: o => o instanceof Float64Array,
      _1406: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1407: (t, s) => t.set(s),
      _1409: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1411: o => o.buffer,
      _1412: o => o.byteOffset,
      _1413: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1414: (b, o) => new DataView(b, o),
      _1415: (b, o, l) => new DataView(b, o, l),
      _1416: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1417: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1418: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1419: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1420: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1421: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1422: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1423: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1424: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1425: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1426: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1427: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1430: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1431: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1432: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1433: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1434: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1435: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1448: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1449: (handle) => clearTimeout(handle),
      _1450: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1451: (handle) => clearInterval(handle),
      _1452: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1453: () => Date.now(),
      _1458: o => Object.keys(o),
      _1459: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1460: (x0,x1) => globalThis.fetch(x0,x1),
      _1461: (x0,x1) => x0.get(x1),
      _1462: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1462(f,arguments.length,x0,x1,x2) }),
      _1463: (x0,x1) => x0.forEach(x1),
      _1465: () => new AbortController(),
      _1466: x0 => x0.getReader(),
      _1467: x0 => x0.read(),
      _1468: x0 => x0.cancel(),
      _1469: x0 => x0.send(),
      ...
      _1476: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1477: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1484: (x0,x1) => x0.key(x1),
      _1493: (s, m) => {
        try {
      ...
      _1660: (x0,x1) => { x0.responseType = x1 },
      _1661: x0 => x0.response,
      _1721: (x0,x1) => { x0.draggable = x1 },
      _1737: x0 => x0.style,
      _1750: (x0,x1) => { x0.oncancel = x1 },
      _1756: (x0,x1) => { x0.onchange = x1 },
      _1796: (x0,x1) => { x0.onerror = x1 },
      _1952: (x0,x1) => { x0.href = x1 },
      _2666: (x0,x1) => { x0.accept = x1 },
      _2680: x0 => x0.files,
      _2706: (x0,x1) => { x0.multiple = x1 },
      _2724: (x0,x1) => { x0.type = x1 },
      _2974: (x0,x1) => { x0.src = x1 },
      _2980: (x0,x1) => { x0.async = x1 },
      _3442: () => globalThis.window,
      _3505: x0 => x0.navigator,
      _3769: x0 => x0.localStorage,
      _3881: x0 => x0.maxTouchPoints,
      _3891: x0 => x0.platform,
      _3895: x0 => x0.vendor,
      _4102: x0 => x0.length,
      _6004: x0 => x0.type,
      _6005: x0 => x0.target,
      _6045: x0 => x0.signal,
      _6106: x0 => x0.firstChild,
      _6117: () => globalThis.document,
      _6199: x0 => x0.body,
      _6532: (x0,x1) => { x0.id = x1 },
      _6555: x0 => x0.innerHTML,
      _6556: (x0,x1) => { x0.innerHTML = x1 },
      _6559: x0 => x0.children,
      _7878: x0 => x0.value,
      _7880: x0 => x0.done,
      _8060: x0 => x0.size,
      _8061: x0 => x0.type,
      _8068: x0 => x0.name,
      _8069: x0 => x0.lastModified,
      _8074: x0 => x0.length,
      _8079: x0 => x0.result,
      _8576: x0 => x0.url,
      _8578: x0 => x0.status,
      _8580: x0 => x0.statusText,
      _8581: x0 => x0.headers,
      _8582: x0 => x0.body,
      _10988: (x0,x1) => { x0.display = x1 },
